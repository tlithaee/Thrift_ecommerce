...
<nav class="bg-orange-500 fixed top-0 left-0 w-full z-50" x-data="{ isOpen: false }">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="flex h-16 items-center justify-between">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <img src="{{ asset('images/thrift.png') }}" class="object-contain h-12 w-12" />
          </div>
        </div>
        ...
        <div class="hidden md:block">
          <div class="lg:ml-10 flex items-baseline lg:space-x-4">
            ...
            <x-nav-link href="/menus" :active="request()->is('menu')">Catalogue</x-nav-link>
            <x-nav-link href="/chefs" :active="request()->is('chefs')">Shop</x-nav-link>
          </div>
        </div>
      </div>
      ...
      <div class="hidden md:flex md:items-center ml-4 items-center md:ml-6 space-x-4">
        @guest
        <a href="/login" class="text-white font-bold text-sm px-4 py-2">Login</a>
        <a href="/register" class="bg-orange-700 hover:bg-orange-500 text-white font-bold text-sm py-2 px-4 rounded-lg">Register</a>
        @endguest
        ...
        <div class="flex items-center space-x-3">
          ...
          <div class="relative" x-data="{ openProfile: false }">
            <button @click="openProfile = !openProfile" @click.outside="openProfile = false" type="button"
              class="relative flex max-w-xs items-center rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-orange-900"
            ...
            <div x-show="openProfile"
              class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-orange-900 focus:outline-none"
